...
import ru.vsu.cs.shevchenko_daniil.Triangle;
...
public class JTableUtils {
    ...
    public static int[] readIntArrayFromJTable(JTable table) throws ParseException {
        try {
            return ru.vsu.cs.shevchenko_daniil.utils.ArrayUtils.toPrimitive(readArrayFromJTable(table, Integer.class, Integer::parseInt, false, 0));
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
