...
public class Table extends JFrame {
    ...
    public Table() {
        ...
        callTriangleButton.addActionListener(e -> {
            try {
        ...
        saveTriangleButton.addActionListener(e -> {
            try {
                int numberOfTriangle = Integer.parseInt(numberOfTriangleField.getText());
                ...
                table1.removeAll();
                numberOfTriangleField.setText("Треугольник успешно изменён. Введите номер нового или же верните старый.");
            } catch (NumberFormatException | ParseException ex) {
                numberOfTriangleField.setText("Треугольник не сохранен. Введите целое число");
            }
        });
    }
}
